...
const { definePartsStyle, defineMultiStyleConfig } = styledSystem.createMultiStyleConfigHelpers(
  anatomy.checkboxAnatomy.keys
);
const vars = styledSystem.defineCssVars("checkbox", ["bg"]);
