...
const Terms: React.FC = () => (
  ...
  >
    <Stack spacing={4}>
      <p>
        Our Terms of Service were last updated on:
        <strong><em>05/16/2024</em></strong>
        .
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          {' '}
          <strong><em>COMPANY_INFORMATION</em></strong>
          .
        </li>
        <li>
          ...
          refers to
          {' '}
          <strong><em>COMPANY_COUNTRY</em></strong>
          .
        </li>
        <li>
        ...
        <li>
          ...
          {' '}
          (also referred as "Terms" or "Terms of Service") mean these Terms of Service that form the entire agreement between You and the Company regarding the use of the Service. This Terms of Service Agreement was generated by
          {' '}
          <a href="https://www.termsfeed.com/blog/sample-terms-of-service-template/">TermsFeed Terms of Service Template</a>
          .
        </li>
        <li>
        ...
        <li>
          ...
          refers to
          {' '}
          <strong><em>WEBSITE_NAME</em></strong>
          , accessible from
          {' '}
          <strong><em>WEBSITE_URL</em></strong>
          .
        </li>
        <li>
          <strong>"You"</strong>
      ...
      <p>
        If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email
        <strong><em>help@lineagecrm.com</em></strong>
        {' '}
      ...
      <h2><strong>Your Feedback to Us</strong></h2>
      ...
      <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall be the waiver of a breach constitute a waiver of any subsequent breach.</p>
      ...
      <h2><strong>Changes to These Terms of Service</strong></h2>
